    ...
    <section className="w-full px-6 md:px-10 py-10 bg-gradient-to-br from-[#fff4e8] via-white to-[#f4f7ff]">
      <div className="relative mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-[1.05fr_1fr] gap-8 md:gap-12 items-stretch">
        ...
        <div className="relative">
          ...
          <div className="relative z-10 flex flex-col justify-center bg-white/70 border border-black/10 p-5 md:p-12 md:h-[520px] shadow-[0_20px_60px_-40px_rgba(0,0,0,0.35)]">
        ...
        <div className="relative min-h-[260px] md:min-h-[520px] overflow-hidden">
