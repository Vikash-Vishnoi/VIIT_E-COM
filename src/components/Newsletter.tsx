        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="flex w-full max-w-xl flex-col md:flex-row gap-3 md:gap-0">
            ...
            <input
              ...
              className="placeholder:text-gray-400 flex-1 bg-transparent border border-white/30 md:border-r-0 px-4 py-3 text-sm text-white outline-none focus:border-white transition-colors"
            />
            <button
              type="submit"
