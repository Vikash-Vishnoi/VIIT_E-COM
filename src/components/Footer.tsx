      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex gap-5 items-center">
            ...
            {/* Twitter / X */}
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-gray-500 hover:text-black transition-colors">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex flex-col sm:flex-row gap-8 md:gap-16 text-xs tracking-wider font-semibold uppercase text-gray-500">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link href="/about" className="hover:text-black transition-colors">About VIIT</Link>
            <Link href="/careers" className="hover:text-black transition-colors">Careers</Link>
          </div>
          <div className="flex flex-col gap-4">
            <Link href="/shipping-returns" className="hover:text-black transition-colors">Shipping & Returns</Link>
            <Link href="/store-locator" className="hover:text-black transition-colors">Store Locator</Link>
