            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-1">
                  <button onClick={toggleWishlist} disabled={loadingWishlist} className={`flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full transition-colors ${loadingWishlist ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-100'}`} aria-label={isWishlisted ? "Remove from wishlist" : "Add to wishlist"}>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill={isWishlisted ? "black" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
