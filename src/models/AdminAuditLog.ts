...
export interface IAdminAuditLog extends Document {
  ...
  action: 'PRODUCT_DELETED' | 'PRODUCT_CREATED' | 'PRODUCT_UPDATED' | 'USER_UPDATED' | 'CATEGORY_CREATED' | 'CATEGORY_UPDATED' | 'CATEGORY_DELETED';
...
const AdminAuditLogSchema = new Schema<IAdminAuditLog>(
  {
    ...
    action: {
      type: String,
      required: true,
      enum: ['PRODUCT_DELETED', 'PRODUCT_CREATED', 'PRODUCT_UPDATED', 'USER_UPDATED', 'CATEGORY_CREATED', 'CATEGORY_UPDATED', 'CATEGORY_DELETED'],
    },
